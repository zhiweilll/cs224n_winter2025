...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        # or alternatively:
        # self.stack.append(self.buffer.pop(0)) # pop the first element from the buffer and append it to the stack
        elif transition == "LA":
            head = self.stack[-1]
        ...
        # or alternatively:
        # head = self.stack[-1]
        # dependent = self.stack.pop(-2) # pop() function removes the element from the list and returns it
        # self.dependencies.append((head, dependent))
        elif transition == "RA":
            head = self.stack[-2]
...
def minibatch_parse(sentences, model, batch_size):
    ...
    # initialize the partial parses
    partial_parses = [PartialParse(sentence) for sentence in sentences]
    # initialize the unfinished parses
    unfinished_parses = partial_parses[:]
